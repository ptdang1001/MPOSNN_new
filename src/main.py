...
def main(args):
    ...
    # Init the output dir
    args.output_dir = "/N/slate/pdang/myProjectsDataRes/20211201FLUXOptimization/result/" + \
                      args.geneExpression_file_name.split('.')[
                          0] + '.' + args.module_source + '.' + args.experiment_name + '/'
    ...
    args.input_dir = "/N/slate/pdang/myProjectsDataRes/20211201FLUXOptimization/data/"

    # load gene expression data
    geneExpression = load_geneExpression(
        args)  # geneExpression is the gene expression data, cols:=samples/cells, rows:=genes
    ...
    compounds_modules, modules_genes = update_compoundsModules_modulesGenes(compounds_modules, modules_genes)
    # sys.exit(1)
    ...
    if args.do_train_snn == 0 and args.do_predict_snn == 1:
        ...
        samples_modules_snn = samples_modules_snn[compounds_modules.columns.values]
        ...
        samples_modules_mpo = samples_modules_mpo[compounds_modules.columns.values]
    ...
    samples_modules_scfea.columns = compounds_modules.columns.values
...
def parse_arguments(parser):
    ...
    parser.add_argument('--compounds_modules_file_name', type=str, default='ANT2_compounds_modules.csv',
    ...
    parser.add_argument('--modules_genes_file_name', type=str, default='ANT2_modules_genes.json',
    ...
    parser.add_argument('--experiment_name', type=str, default="fullBatch")
    ...
    parser.add_argument('--n_train_batch_snn', type=int, default=100000)
